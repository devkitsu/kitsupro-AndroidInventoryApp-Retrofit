...
public class stok_barang extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    @BindView(R.id.recyclerView_stok) RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stok_barang);
        ButterKnife.bind(this);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Stok Barang");
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewAdapter_Stok(stok_barang.this, results);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
